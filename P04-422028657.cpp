...
int main()
{
	...
	*/
	...
	while (!mainWindow.getShouldClose())
	{
		...
		/* Aquí empieza el ejercicio 01 de la práctica.
		...
		//inicia tercera llanta frente derecha
		...
		*/
		...
		model = modelaux;
		///inicia pata delantera derecha

		//articulación pata delantera der
		color = glm::vec3(0.3f, 0.17f, 0.007f);  //café oscuroooooooOO
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		...
		//articulación pata delantera izq parte 2
		color = glm::vec3(0.3f, 0.17f, 0.007f);  //café oscuroooooooOO
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		model = glm::translate(model, glm::vec3(0.0f, -3.5f, 0.0f));
		//se mueve con g
		...
		////Inicia pata traseraa izq

		//articulación pata trasera izq
		color = glm::vec3(0.3f, 0.17f, 0.007f);  //café oscuroooooooOO
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		model = glm::translate(model, glm::vec3(1.5f, -2.0f, 1.0f));
		//se mueve con j
		...
		//articulación pata trasera izq parte 2
		color = glm::vec3(0.3f, 0.17f, 0.007f);  //café oscuroooooooOO
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		model = glm::translate(model, glm::vec3(0.0f, -3.5f, 0.0f));
		//se mueve con k
		...
		////Inicia pata traseraa der

		//articulación pata trasera der
		color = glm::vec3(0.3f, 0.17f, 0.007f);  //café oscuroooooooOO
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		model = glm::translate(model, glm::vec3(1.5f, -2.0f, -1.0f));
		//se mueve con z
