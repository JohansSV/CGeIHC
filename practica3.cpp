...
void CrearCono(int res, float R) {
	...
	Mesh* cono = new Mesh();
	//mesh geometry no dibuja gl_triangulos, si no gl_triangle_fan ventilador de triangulos que comparten un vertice en común
...
int main()
{
	...
	CrearPiraminx();//indice 0 en meshColorlist
	CreateShaders();
