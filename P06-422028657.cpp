...
// average normals
	GLfloat cubo_vertices[] = {
		...
		-0.5f,  0.5f,  0.5f,	0.74f,	0.64f,		1.0f,	0.0f,	0.0f,
		-0.5f,  0.5f,  -0.5f,	0.51f,	0.64f,		1.0f,	0.0f,	0.0f,

		// bottom
		//x		y		z		S		T
		-0.5f, -0.5f,  0.5f,	1.0f,  0.34f,		0.0f,	1.0f,	0.0f,
		0.5f,  -0.5f,  0.5f,	0.76f,	0.34f,		0.0f,	1.0f,	0.0f,
		 0.5f,  -0.5f,  -0.5f,	0.76f,	0.64f,		0.0f,	1.0f,	0.0f,
		-0.5f, -0.5f,  -0.5f,	1.0f,	0.64f,		0.0f,	1.0f,	0.0f,
	...
	// Cara 1 Frontal Superior
     0.0f,  0.7f,  0.0f,  0.18f, 1.0f,  0.0f,  0.707f,  0.707f,  
     0.5f,  0.0f,  0.5f,  0.38f, 0.7f,  0.0f,  0.707f,  0.707f,  
    -0.5f,  0.0f,  0.5f,  0.0f, 0.7f,  0.0f,  0.707f,  0.707f,  
    
    // Cara 2 Derecha Superior
	 0.0f,  0.7f,  0.0f,  0.38f, 0.7f,  0.0f,  0.707f,  0.707f,  
     0.5f,  0.0f,  0.5f,  0.18f, 1.0f,  0.707f,  0.707f,  0.0f,  
     0.5f,  0.0f, -0.5f,  0.57f, 1.0f,  0.707f,  0.707f,  0.0f,  
    
    // Cara 3 Posterior Superior
	 0.0f,  0.7f,  0.0f,  0.57f, 1.0f,  0.0f,  0.707f,  0.707f,  
     0.5f,  0.0f, -0.5f,  0.75f, 0.67f,  0.0f,  0.707f, -0.707f,  
    -0.5f,  0.0f, -0.5f,  0.38f, 0.67f,  0.0f,  0.707f, -0.707f,  
    
    // Cara 4 Izquierda Superior
	 0.0f,  0.7f,  0.0f,  0.18f, 0.67f,  0.0f,  0.707f,  0.707f,  
    -0.5f,  0.0f, -0.5f,  0.0f, 0.33f, -0.707f,  0.707f,  0.0f,  
    -0.5f,  0.0f,  0.5f,  0.38f, 0.33f, -0.707f,  0.707f,  0.0f,  
    
    // Cara 5 Frontal Inferior
     0.0f, -0.7f,  0.0f,  0.57f, 0.67f,  0.0f, -0.707f,  0.707f,  
    -0.5f,  0.0f,  0.5f,  0.18f, 0.67f,  0.0f, -0.707f,  0.707f,  
     0.5f,  0.0f,  0.5f,  0.38f, 0.33f,  0.0f, -0.707f,  0.707f,  
    
    // Cara 6 Derecha Inferior
     0.0f, -0.7f,  0.0f,  0.57f, 0.67f,  0.707f, -0.707f,  0.0f,  
     0.5f,  0.0f,  0.5f,  0.38f, 0.33f,  0.707f, -0.707f,  0.0f,  
     0.5f,  0.0f, -0.5f,  0.75f, 0.33f,  0.707f, -0.707f,  0.0f,  
    
    // Cara 7 Posterior Inferior
     0.0f, -0.7f,  0.0f,  0.18f, 0.33f,  0.0f, -0.707f, -0.707f, 
     0.5f,  0.0f, -0.5f,  0.0f, 0.0f,  0.0f, -0.707f, -0.707f,  
    -0.5f,  0.0f, -0.5f,  0.37f, 0.0f,  0.0f, -0.707f, -0.707f,  
    
    // Cara 8 Izquierda Inferior
     0.0f, -0.7f,  0.0f,  0.57f, 0.33f, -0.707f, -0.707f,  0.0f,  
    -0.5f,  0.0f, -0.5f,  0.75f, 0.0f, -0.707f, -0.707f,  0.0f,  
    -0.5f,  0.0f,  0.5f,  0.37f, 0.0f, -0.707f, -0.707f,  0.0f   
	};
	Mesh* dado8 = new Mesh();
...
int main()
{
	...
	dadoTexture.LoadTextureA(); //LoadTextureA para png o tga con canal alpha
